...
class ElasticBlock(EllipticCoerciveProblem):
    ...
    def assemble_operator(self, term):
        ...
        if term == "a":
            ...
            bc0 = [DirichletBC(self.V, Constant((0.0, 0.0, 0.0)), self.boundaries, 1),  # fully fixed (u, v, w = 0)
                   DirichletBC(self.V.sub(0), Constant(0.0), self.boundaries, 2),       # displacement u = 0
                   DirichletBC(self.V.sub(1), Constant(0.0), self.boundaries, 3)]       # displacement v = 0
            return (bc0,)
